...
const gameCards = [
  {
    ...
    icon: "\u{2694}\u{FE0F}",
    title: "Movie Battles",
    description: "Build a bracket.",
    bullets: ["Tournament brackets", "Head-to-head", "Winner reveal"],
    accent:
  ...
  },
  {
    ...
    icon: "\u{1F3B2}",
    title: "Random",
    description: "Filter or roll one title.",
    bullets: ["Genre", "Year", "Rating"],
    accent:
  ...
  },
  {
    ...
    description: "Load titles and spin the wheel.",
    bullets: ["Wheel", "Spin", "Recent wins"],
    accent:
    ...
    <main className="min-h-screen py-8 text-white md:py-12">
      <div className="page-frame space-y-8 md:space-y-12">
          ...
          <div className="rounded-[1.5rem] border border-white/10 bg-black/20 p-4 md:p-5">
            ...
            <div className="mt-4 grid gap-3 sm:grid-cols-3">
              <div className="rounded-2xl border border-white/10 bg-white/6 px-4 py-3 text-sm text-zinc-200">
                <div className="font-semibold text-white">Matchups</div>
                <div className="mt-1 text-zinc-400">Bracket play</div>
              </div>
              <div className="rounded-2xl border border-white/10 bg-white/6 px-4 py-3 text-sm text-zinc-200">
                <div className="font-semibold text-white">Random</div>
                <div className="mt-1 text-zinc-400">Filter or roll</div>
              </div>
              <div className="rounded-2xl border border-white/10 bg-white/6 px-4 py-3 text-sm text-zinc-200">
                <div className="font-semibold text-white">Roulette</div>
                <div className="mt-1 text-zinc-400">Group pick</div>
              </div>
            </div>
          </div>
        </DecisionHero>
        ...
        <DiscoverySearchSection
          eyebrow="Search"
          title="Search first"
          description="Find a title before you choose."
        />
