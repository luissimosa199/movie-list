          ...
          <div className="relative z-10 grid gap-6 xl:grid-cols-[minmax(0,1.3fr)_minmax(22rem,0.9fr)] xl:items-end">
            <div>
              ...
              <p className="mt-4 max-w-2xl text-sm leading-7 text-zinc-300 md:text-base">
                Search a title or browse popular, top-rated, and upcoming picks.
              </p>

              <div className="mt-6 flex flex-wrap gap-3 text-sm text-zinc-300">
                <div className="rounded-full border border-white/10 bg-white/6 px-4 py-2">
                  <span className="text-white">3 sections</span>
                </div>
                <div className="rounded-full border border-white/10 bg-white/6 px-4 py-2">
...
export const metadata = {
  title: "Movies - Browse Popular, Top Rated, and Upcoming",
  description: "Browse movies by popularity, rating, and upcoming releases.",
};
